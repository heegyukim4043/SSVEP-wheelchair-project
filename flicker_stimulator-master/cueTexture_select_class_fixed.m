function [cueTexture]=cueTexture_select_class_fixed(winWidth,winHeight,targetWidth,targetHeight,class_x,class_y,Color,baseimage,margin_x,margin_y,mask_matrix)
...
%                 else 
%                     for color_ind = 1:3
%                         targetMatrix{(ind_Height-1)*class_x +ind_Width}(ind_h,ind_w,color_ind) = 0;
%                     end
                end
            end
        end
